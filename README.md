...
### 🔗 [**Project site**](https://sahilsharma0309.github.io/banking-complaints-analysis/) &nbsp;·&nbsp; [**Interactive dashboard**](https://public.tableau.com/views/banking_complaints_dashboard/Dashboard) &nbsp;·&nbsp; [**Business report**](reports/insights.md)
...
Tableau reads four purpose-built PostgreSQL views, so no business logic lives in
the workbook — the 500-complaint floor, the resolved-only denominators, the trend
window and the FDIC join are all in versioned SQL:
